...
function table_export() {
    // var value = $("#s7200_network_xls_config").edatagrid('getRows');
    var obj = get_select();
...
$(function() {
    $("#s7200_network_xls_config").edatagrid({
        ...
        onClickRow: function(index, row) {
            $("#s7200_network_xls_config").edatagrid('endEdit', index);
        },
        onDestroy: function(index, row) {
            ...
            if (result == 'true') {
                ...
                $("#s7200_network_xls_config").datagrid('reload');
            }
        },
        //保存后执行
        onEndEdit: function(index, row, changs) {
            var old_data = $('#s7200_network_xls_config').datagrid('getEditor', { index: index, field: "tagCode" });
            var obj = get_select();
            status = false;
        ...
        //     $('#s7200_network_xls_config').edatagrid('unselectAll')
        // },
        idField: 'tagCode',
        columns: [
            [{
                ...
                },
                {
                    ...
                    editor: {
                        ...
                        options: {
                            panelHeight: 'auto',
                            method: 'get',
                            url: "../static/json/s7200Type.json",
                            editable: false,
                            valueField: "text",
                            textField: "text",
                            required: true
        ...
        toolbar: [{
            ...
            iconCls: 'icon-add',
            handler: function() {
                $('#s7200_network_xls_config').edatagrid('saveRow');
                var obj = get_select();
                ...
                $('#s7200_network_xls_config').edatagrid('addRow', {
                    row: {
                        tagCode: tagCode,
                        rate: 1.00
                    }
            ...
            iconCls: 'icon-redo',
            handler: function() {
                $('#s7200_network_xls_config').edatagrid('cancelRow');
            }
        }, '-', {
            text: self.parent.messages[initial]['common']['remove'],
            iconCls: 'icon-remove',
            handler: function() {
                $("#s7200_network_xls_config").edatagrid('destroyRow');
            }
        }, '-', {
                        ...
                        $("#templete_dialog").dialog({
                            ...
                            buttons: [{
                                    ...
                                    handler: function() {
                                        ...
                                        if (result == "true") {
                                            $("#s7200_network_xls_config").edatagrid('reload');
            ...
            iconCls: 'icon-template',
            handler: function() {
                // values = $("#s7200_network_xls_config").datagrid('getRows');
