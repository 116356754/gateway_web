...
$(function() {
    ...
    $("#alarm_xls_config").edatagrid({
        ...
        loadFilter: function(data, parentId) {
            ...
            content = JSON.parse(selectsql("alarm", sql));
        ...
        toolbar: [{
            ...
            iconCls: 'icon-add',
            handler: function() {
                $('#alarm_xls_config').edatagrid('saveRow');
                var obj = get_select();
                ...
                $('#alarm_xls_config').edatagrid('addRow', {
                    row: {
                        tagCode: tagCode,
                        rate: 1.00
                    }
            ...
            iconCls: 'icon-redo',
            handler: function() {
                $('#alarm_xls_config').edatagrid('cancelRow');
            }
        }, '-', {
            text: self.parent.messages[initial]['common']['remove'],
            iconCls: 'icon-remove',
            handler: function() {
                $("#alarm_xls_config").edatagrid('destroyRow');
            }
        }, '-', {
                        ...
                        $("#templete_dialog").dialog({
                            ...
                            buttons: [{
                                    ...
                                    handler: function() {
                                        ...
                                        if (result == "true") {
                                            $("#alarm_xls_config").edatagrid('reload');
